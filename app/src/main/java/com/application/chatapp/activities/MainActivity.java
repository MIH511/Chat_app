...
import com.application.chatapp.adapters.RecentConversationAdapter;
import com.application.chatapp.databinding.ActivityMainBinding;
        ...
        if (v!=null){
            ...
            for(DocumentChange documentChange: v.getDocumentChanges()){
                if(documentChange.getType()== DocumentChange.Type.ADDED){
                    ...
                    if(preferenceManager.getString(Constants.KEY_USER_ID).equalsIgnoreCase(senderId)){
                    ...
                    for(int i=0 ; i<conversations.size();i++){
                        ...
                        if(conversations.get(i).senderId.equalsIgnoreCase(senderId) && conversations.get(i).receiverId.equalsIgnoreCase(receiverId)){
